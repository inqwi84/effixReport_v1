...
namespace EffixReportSystem.Views.Report.ReportTemplates
{
    ...
    /// </summary>
    public partial class AvtoAleaJLRHeadReport : Telerik.Reporting.Report
    {
        //public HeadReport()
        //{
        //    InitializeComponent();
        ...
        public AvtoAleaJLRHeadReport(string projName, DateTime beginPeriod, DateTime endPeriod)
        {
            InitializeComponent();
        ...
        public AvtoAleaJLRHeadReport(List<EF_Publication> pGroupList, string resultNameList,int index)
        {
            InitializeComponent();
